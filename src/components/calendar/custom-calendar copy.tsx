...
import { format, addYears, subYears, getDaysInMonth, addMonths, subMonths, startOfMonth, endOfMonth, startOfWeek, endOfWeek, addDays, isSameMonth, isSameDay, parseISO, getMonth, getYear, getQuarter, startOfQuarter, endOfQuarter, addQuarters, subQuarters } from 'date-fns';
  ...
  return (
    <div className="flex flex-col border border-gray-300 rounded-lg shadow-md overflow-hidden bg-white">
      ...
      <div className="flex border-b border-gray-200 bg-gray-100">
        ...
        <div className="flex flex-grow overflow-x-auto"> {/* This div now controls horizontal scrolling for the header */}
      ...
      {(currentView === 'day' || currentView === 'week' || currentView === 'month-detailed' || currentView === 'quarter-detailed') && (
        <div className="flex border-b border-gray-200 bg-gray-50">
          ...
          <div className="flex flex-grow overflow-x-auto"> {/* This div now controls horizontal scrolling for daily notes */}
            <div className="flex" style={{ minWidth: currentView === 'day' ? `${DAY_VIEW_TOTAL_WIDTH_PX}px` : `${columnsToDisplay.length * DEFAULT_DAY_COLUMN_MIN_WIDTH_PX}px` }}>
              {(columnsToDisplay as Date[]).map((day) => (
                <div
                  key={`daily-note-${day.toISOString()}`}
