...
const Event: React.FC<{
    ...
    if (currentView === 'day') {
        ...
        return (
            <div
                className='group relative mb-1 rounded-md p-1 text-xs font-medium text-white shadow-md' // Added group
                style={{
                    backgroundColor: resourceColor,
                    width: '100%',
                    overflow: 'hidden',
                ...
                {daysInView.map((day) => (
                    <div
                        ...
                        style={{
                            ...
                            minHeight: '50px',
                            width: currentView === 'day' ? `${DAY_VIEW_TOTAL_WIDTH_PX}px` : '120px',
                            minWidth: currentView === 'day' ? `${DAY_VIEW_TOTAL_WIDTH_PX}px` : '120px'
                        }}
...
const ShiftForm: React.FC<{
    ...
    popupX: number | null;
    popupY: number | null;
}> = ({ isOpen, onClose, initialDate, popupX, popupY }) => {
        ...
        <div className='flex flex-col overflow-hidden rounded-lg border border-gray-300 bg-white shadow-md'>
            ...
            <div className='flex border-b border-gray-200 bg-gray-100'>
                ...
                {currentView === 'day' ? (
                    ...
                    <div className='flex flex-grow' style={{ minWidth: `${columnsToDisplay.length * 120}px` }}>
                        {' '}
                        ...
                        {(columnsToDisplay as Date[]).map((day) => (
                            <div
                                ...
                                style={{ width: '120px' }} // Fixed width for each day column in detailed views
                            >
...
const App: React.FC = () => {
    ...
    // Removed Firebase state and related useEffects
