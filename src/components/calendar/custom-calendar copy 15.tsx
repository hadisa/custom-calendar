                ...
                {daysInView.map((day) => (
                    <div
                        ...
                        className={cn(
                            ...
                            currentView === 'day' ? 'flex-none' : 'flex-1' // flex-none for day, flex-1 for week/detailed
                        )}
                        style={{
                            height: '100px', // Fixed height for rows in all detailed views
                            minHeight: '100px', // Min height for consistency
                            width: currentView === 'day' ? `${DAY_VIEW_TOTAL_WIDTH_PX}px` : undefined, // Fixed width for day, undefined for week
                            minWidth:
                                currentView === 'day'
                                    ? `${DAY_VIEW_TOTAL_WIDTH_PX}px`
                                    : DEFAULT_DAY_COLUMN_MIN_WIDTH_PX, // Fixed min-width for month/quarter detailed
                ...
                {daysInView.map((day) => (
                    <div
                        ...
                        style={{
                            ...
                            width: currentView === 'day' ? `${DAY_VIEW_TOTAL_WIDTH_PX}px` : undefined, // Fixed width for day, undefined for week
                            minWidth:
                                currentView === 'day' ? `${DAY_VIEW_TOTAL_WIDTH_PX}px` : DEFAULT_DAY_COLUMN_MIN_WIDTH_PX // Fixed min-width for month/quarter detailed
                        }}
            ...
            <div className='flex border-b border-gray-200 bg-gray-100'>
                ...
                {currentView === 'day' ? (
                    ...
                    <div
                        ...
                        style={{ minWidth: `${columnsToDisplay.length * DEFAULT_DAY_COLUMN_MIN_WIDTH_PX}px` }}>
                        {' '}
