...
const DEFAULT_DAY_COLUMN_WIDTH_PX = 120; // Default width for day columns in week/month/quarter detailed views
...
const ResourceRow: React.FC<{
    ...
    daysInView: Date[];
    currentView: 'week' | 'day' | 'month-detailed' | 'quarter-detailed';
    onCellClick: (date: Date, event: React.MouseEvent, resourceId?: string) => void;
                        ...
                        style={{
                            ...
                            width:
                                currentView === 'day'
                                    ...
                                    : `${DEFAULT_DAY_COLUMN_WIDTH_PX}px`, // Fixed width for day/week/month/quarter detailed days
                            minWidth:
                                currentView === 'day'
                                    ? `${DAY_VIEW_TOTAL_WIDTH_PX}px`
                                    : `${DEFAULT_DAY_COLUMN_WIDTH_PX}px`,
            ...
            <div className='flex flex-grow'>
                {daysInView.map((day) => (
                    <div
                        ...
                        onClick={(e) => onCellClick(day, e, openShiftResourceId)} // Pass openShiftResourceId
                    >
...
}> = ({ isOpen, onClose, initialDate, popupX, popupY, defaultResourceId }) => {
            ...
            <div className='flex border-b border-gray-200 bg-gray-100'>
                ...
                {currentView === 'day' ? (
                    ...
                    <div
                        ...
                        style={{ minWidth: `${columnsToDisplay.length * DEFAULT_DAY_COLUMN_WIDTH_PX}px` }}>
                        {' '}
                        {/* Ensure horizontal scroll for month/quarter detailed */}
                        {(columnsToDisplay as Date[]).map((day) => (
                            <div
                                ...
                                style={{ width: `${DEFAULT_DAY_COLUMN_WIDTH_PX}px` }} // Fixed width for each day column in detailed views
                            >
            ...
            <div className='flex-grow overflow-y-auto' style={{ maxHeight: 'calc(100vh - 250px)' }}>
                <div className='flex'>
                    ...
                    <div className='flex-grow overflow-x-auto'>
                        {' '}
                        {/* This will handle horizontal scrolling for day/week views */}
                            ...
                            <div key={group.id} className='mb-2 last:mb-0'>
                                ...
                                {group.isExpanded && (
                                    <OpenShiftsRow
                                        group={group}
                                        daysInView={
                                            currentView === 'day' ? [currentWeekStart] : (columnsToDisplay as Date[])
                                        }
                                        currentView={currentView}
...
const App: React.FC = () => {
    ...
    const [events, setEvents] = useState<ShiftEvent[]>([
        ...
        },
        {
            ...
            end: new Date(today.getFullYear(), today.getMonth(), today.getDate(), 20, 0, 0)
        }
    ]);
    ...
    const openAddShiftForm = (date: Date | null = null, event?: React.MouseEvent, resourceId?: string) => {
