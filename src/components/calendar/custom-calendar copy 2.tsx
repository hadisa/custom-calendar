 ...
 */
const MainCalendar: React.FC<{ currentWeekStart: Date }> = ({ currentWeekStart }) => {
                        ...
                        {group.isExpanded && (
                            <div className='overflow-hidden transition-all duration-300 ease-in-out'>
                                {resources
                                    ...
                                    .map((resource) => (
                                        <ResourceRow key={resource.id} resource={resource} daysInWeek={daysInWeek} />
                                    ))}
                            </div>
                        )}
                    </div>
...
const App: React.FC = () => {
    ...
    const goToPreviousWeek = () => {
        setCurrentWeekStart((prev) => {
            const newDate = subWeeks(prev, 1); // Use date-fns subWeeks
    ...
    const goToNextWeek = () => {
        setCurrentWeekStart((prev) => {
            const newDate = addWeeks(prev, 1); // Use date-fns addWeeks

            return newDate;
        });
    };

    // Helper for date-fns addWeeks and subWeeks
        ...
        <CalendarContext.Provider value={calendarContextValue}>
          ...
          `}
                ...
                <div className='mx-auto max-w-7xl py-6 sm:px-6 lg:px-8'>
                    ...
                    <MainCalendar currentWeekStart={currentWeekStart} />
                </div>
