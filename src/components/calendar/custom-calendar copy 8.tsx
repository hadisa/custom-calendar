...
const Event: React.FC<{ event: ShiftEvent; resourceColor: string; currentView: 'week' | 'day' | 'month-detailed' }> = ({
    event,
    resourceColor,
    currentView
}) => {
    ...
    if (currentView === 'day') {
        ...
        // 'week' or 'month-detailed' view - simple block stacking
        return (
            <div
...
const ResourceRow: React.FC<{
    resource: Resource;
    daysInWeek: Date[];
    currentView: 'week' | 'day' | 'month-detailed';
}> = ({ resource, daysInWeek, currentView }) => {
...
const MainCalendar: React.FC<{
    ...
    currentView: 'week' | 'day' | 'year' | 'quarter' | 'month' | 'month-detailed';
    ...
    // Default rendering for 'week' and 'day' views, and now 'month-detailed'
    return (
        <div className='flex flex-col overflow-hidden rounded-lg border border-gray-300 bg-white shadow-md'>
            ...
            <div className='flex border-b border-gray-200 bg-gray-100'>
                ...
                {/* Render hours for 'day' view, or dates for 'week'/'month-detailed' view */}
                {currentView === 'day'
...
const App: React.FC = () => {
    ...
    const [currentView, setCurrentView] = useState<'week' | 'day' | 'year' | 'quarter' | 'month' | 'month-detailed'>(
        'week'
    ); // Added 'month-detailed' to view options
